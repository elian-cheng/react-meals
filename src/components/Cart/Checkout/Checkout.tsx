...
const Checkout = (props: { onConfirm: Function; onCancel: MouseEventHandler<HTMLElement> }) => {
    ...
    <form
      ...
      <div className={postalCodeControlClasses}>
        ...
        {!formInputsValidity.postalCode && (
          <p className={classes.error}>Please enter a valid postal code (5 characters long)!</p>
        )}
      </div>
